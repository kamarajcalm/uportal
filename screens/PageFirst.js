          ...
          <View style={{flex:1,justifyContent:'center',paddingHorizontal:width*0.04,marginVertical:8}}>
              ...
              <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                ...
                <View style={{paddingHorizontal:10}}>
                  <Text style={[styles.text,{color:'#fff',fontSize:14,
                          fontWeight:'600'}]}  numberOfLines={1}>{item.name}</Text>
                  <Text style={[styles.text,{color:'#fff',fontSize:12,
                          fontWeight:'600'}]} numberOfLines={1}>{item.dest}</Text>
                  <Text style={[styles.text,{color:'#828282',fontSize:12,
                          fontWeight:'600'}]} numberOfLines={1}>{item.time}</Text>
                </View>
              </View>
                ...
                <View>
                  ...
                  <TouchableWithoutFeedback>
                    <Text style={[styles.text,
                      {color:'#fff',fontSize:14,paddingVertical:6,fontWeight:'600'}]}>Read more</Text>
                  </TouchableWithoutFeedback>
                </View>
              }
              {item.dest &&
            ...
            <View style={{justifyContent:'space-between',borderWidth:1,flexDirection:'row',
              ...
              <TouchableOpacity style={{flexDirection:'row'}} onPress={()=>{this.comment(item,index)}}>
                ...
                <Text style={[styles.text,{color:'#fff',fontSize:14,
                            paddingHorizontal:4,fontWeight:'600'}]}>COMMENT</Text>
              </TouchableOpacity>
              <TouchableOpacity style={{flexDirection:'row'}}>
                <Feather name='share-2' size={20} color='#fff'/>
                <Text style={[styles.text,{color:'#fff',fontSize:14,
                            paddingHorizontal:4,fontWeight:'600'}]}>SHARE</Text>
              </TouchableOpacity>
            </View>
      ...
      <View style={{flex:1}}>
        ...
        <View style={{flexDirection:'row',marginTop:4,justifyContent:'space-between',
          ...
          <View style={{flexDirection:'row'}}>
            ...
            <Text style={[styles.text,{color:'#fff',paddingHorizontal:6,
                      fontWeight:'700',fontSize:14}]}>PHOTO/VIDEOS</Text>
          </View>
          <View style={{flexDirection:'row'}}>
            <FontAwesome name='image' size={20} color='#fff'/>
            <Text style={[styles.text,{color:'#fff',paddingHorizontal:6,
                      fontWeight:'700',fontSize:14}]}>MY WALL</Text>
          </View>
        </View>
      </View>
    )
