...
const listofdetails=[{id:1,icon:'',name:'MARKS'},{id:2,icon:'',name:'ATTENDANCE'},
                     ...
                     {id:5,icon:'',name:'SYLLABUS & TIMETABLE'},
                     {id:6,icon:'',name:'CALENDAR AND REMINDERS'},
  ...
  profileHead=()=>{
    return(
      <View style={{justifyContent:'center',backgroundColor:'#000'}}>
        ...
        <Text style={[styles.text,{fontSize:12,color:'#fff',fontWeight:'700',
                textAlign:'left',paddingHorizontal:20,
                paddingVertical:10}]}>Lorem ipsum dolor sit amet, consectetur ipsum
        ...
        <View style={{backgroundColor:'#323232',marginHorizontal:10}}>
          <Text style={[styles.text,{color:'#fff',fontSize:14,fontWeight:'700',
                textAlign:'center',paddingVertical:4}]}>EDIT PROFILE</Text>
        </View>
      </View>
    )
  }
  images=()=>{
    return(
        <View style={{marginTop:2,borderRadius:10}}>
          <FlatList style={{}} data={this.state.images}
  ...
  tabs=()=>{
    ...
    return(
      <View style={{marginTop:10}}>
        <Animated.View
            style={{height:1,width:'50%',backgroundColor:'#fff',position:'absolute',
                      top: 0,left:0,transform:[{translateX:left}]}}/>
          ...
          {tabs.map((item, i) => {
            return (
              <TouchableOpacity key={i}
                ...
                <Image source={(item.img)}  color="#fff"
