    ...
    <View>
      <FlatList style={{}} data={this.state.presentdata} keyExtractor={(item, index) => index.toString()} renderItem={({item, index})=>(
        ...
        <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
          ...
          <Text style={[styles.text,{color:'#fff',fontSize:item.period=='PERIOD'?16:14,fontWeight:'700'}]}>{item.period}</Text>
          </View>
          <View style={{width:width*0.27}}>
          <Text style={[styles.text,{color:'#fff',fontSize:item.period=='PERIOD'?16:14,fontWeight:'700'}]}>{item.subject}</Text>
          </View>
          <View style={{width:width*0.37}}>
          <Text style={[styles.text,{color:'#fff',fontSize:item.period=='PERIOD'?16:14,fontWeight:'700'}]}>{item.faculty}</Text>
          </View>
        </View>

        <View style={{borderWidth:item.period=='PERIOD'?0:0.2,borderColor:'#fff',marginVertical:20}}></View>
        </View>
      )}
     />
    </View>
  ...
  return(
    <View>
      <FlatList style={{}} data={this.state.presentdata} keyExtractor={(item, index) => index.toString()} renderItem={({item, index})=>(
        ...
        <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
          <View style={{width:width*0.2}}>
          <Text style={[styles.text,{color:item.period=='PERIOD'?'#fff':'#C60000',fontSize:item.period=='PERIOD'?16:14,fontWeight:'700'}]}>{item.period}</Text>
          </View>
          <View style={{width:width*0.27}}>
          <Text style={[styles.text,{color:item.period=='PERIOD'?'#fff':'#C60000',fontSize:item.period=='PERIOD'?16:14,fontWeight:'700'}]}>{item.subject}</Text>
          </View>
          <View style={{width:width*0.37}}>
          <Text style={[styles.text,{color:item.period=='PERIOD'?'#fff':'#C60000',fontSize:item.period=='PERIOD'?16:14,fontWeight:'700'}]}>{item.faculty}</Text>
          </View>
        </View>
  ...
  return(
    <View>
      <FlatList style={{}} data={this.state.presentdata} keyExtractor={(item, index) => index.toString()} renderItem={({item, index})=>(
        ...
        <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
          <View style={{width:width*0.2}}>
          <Text style={[styles.text,{color:item.period!='3'?'#fff':'#C60000',fontSize:item.period=='PERIOD'?16:14,fontWeight:'700'}]}>{item.period}</Text>
          </View>
          <View style={{width:width*0.27}}>
          <Text style={[styles.text,{color:item.period!='3'?'#fff':'#C60000',fontSize:item.period=='PERIOD'?16:14,fontWeight:'700'}]}>{item.subject}</Text>
          </View>
          <View style={{width:width*0.37}}>
          <Text style={[styles.text,{color:item.period!='3'?'#fff':'#C60000',fontSize:item.period=='PERIOD'?16:14,fontWeight:'700'}]}>{item.faculty}</Text>
          </View>
        </View>
                ...
                <View style={{marginHorizontal:30}}>
                    <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginVertical:10}}>
                      <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',paddingHorizontal:10}}>
                        ...
                        <Text style={[styles.text,{color:'#fff',fontSize:14,fontWeight:'400',paddingHorizontal:10}]}>PRESENT</Text>
                      </View>
                      <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',paddingHorizontal:10}}>
                        <View style={{height:20,width:20,backgroundColor:'#C60000'}}></View>
                        <Text style={[styles.text,{color:'#fff',fontSize:14,fontWeight:'400',paddingHorizontal:10}]}>ABSENT</Text>
                      </View>
                    </View>
                    <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginVertical:10}}>
                      <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',paddingHorizontal:10}}>
                        <View style={{height:20,width:20,backgroundColor:'#515151'}}></View>
                        <Text style={[styles.text,{color:'#fff',fontSize:14,fontWeight:'400',paddingHorizontal:10}]}>HOLYDAY</Text>
                      </View>
                      <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',paddingHorizontal:10}}>
                        <View style={{height:20,width:20,backgroundColor:'#C37500'}}></View>
                        <Text style={[styles.text,{color:'#fff',fontSize:14,fontWeight:'400',paddingHorizontal:10}]}>PARTIAL</Text>
                      </View>
                    </View>
                </View>
                <Text style={[styles.text,{color:'#fff',fontSize:16,fontWeight:'700',textAlign:'center',paddingVertical:10}]}>{date1}</Text>
                <View>
                {this.state.holyday&&<Text style={[styles.text,{color:'#fff',fontSize:16,fontWeight:'700',textAlign:'center'}]}>DECLARED AS HOLIDAY</Text>}
