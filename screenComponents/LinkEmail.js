    ...
    return (
      <View style={{flex:1,backgroundColor:'#000'}}>
            ...
            <View style={{marginVertical:20,marginHorizontal:25}}>
              <Text style={{color:'#fff',fontSize:16,paddingVertical:10}}>ENTER EMAIL ID</Text>
              <TextInput style={{height: 45,borderWidth:1,borderColor:'#000',alignSelf:'center',
               ...
               />
               <TouchableOpacity style={{alignSelf:'center',paddingHorizontal:25,paddingVertical:10,backgroundColor:'#5e5e5e',marginVertical:20,borderRadius:7}} onPress={()=>{receivedValue(this.state.emailid)
            this.props.navigation.goBack()}}>
               <Text style={{color:'#fff',fontSize:18}}>LINK</Text>
               </TouchableOpacity>
               </View>
            </View>
      </View>
