    ...
    return(
      <View style={{width:width*0.65,borderWidth:0,borderColor:'#fff',
        ...
        <View style={{width:width*0.65,borderWidth:0,
                    ...
                    marginHorizontal:0,borderRadius:10,alignItems:'center',shadowRadius: 7,
                    shadowColor:'blur(5.46863px)',shadowOpacity: 0.1,elevation:5,}}>
          <View style={{width:width*0.65,justifyContent:'center',alignItems:'center'}}>
            <Text style={[styles.text,{color:'#fff',fontSize:16,paddingVertical:10,
                        paddingLeft:0,fontWeight:'700'}]}>{item.subject}</Text>
        ...
        <View style={{paddingVertical:10}}>
          <View style={styles.view1}>
            <Text style={[styles.text,{color:'#fff',fontSize:14,paddingVertical:4,flex:0.6,
                  fontWeight:'700'}]}>Qualification</Text>
            <Text style={[styles.text,{color:'#fff',fontSize:12,paddingVertical:4,flex:0.4,
                  fontWeight:'400'}]}>{item.quali}</Text>
          </View>
          <View style={styles.view1}>
            <Text style={[styles.text,{color:'#fff',fontSize:14,paddingVertical:4,flex:0.6,
                  fontWeight:'700'}]}>Designation</Text>
            <Text style={[styles.text,{color:'#fff',fontSize:12,paddingVertical:4,flex:0.4,
                  fontWeight:'400'}]}>{item.quali}</Text>
          </View>
          <View style={styles.view1}>
            <Text style={[styles.text,{color:'#fff',fontSize:14,paddingVertical:4,flex:0.6,
                  fontWeight:'700'}]}>Email ID</Text>
            <Text style={[styles.text,{color:'#fff',fontSize:12,paddingVertical:4,flex:0.4,
                  fontWeight:'400'}]} numberOfLines={1}>{item.emailid}</Text>
          </View>
          <View style={styles.view1}>
            <Text style={[styles.text,{color:'#fff',fontSize:14,paddingVertical:4,
                  flex:0.6,fontWeight:'700'}]}>Class handling</Text>
            <Text style={[styles.text,{color:'#fff',fontSize:12,paddingVertical:4,
                  flex:0.4,fontWeight:'400'}]}>{item.classeshandling}</Text>
          </View>

          <TouchableOpacity style={{alignSelf:'center',backgroundColor:'#000',borderRadius:7,
                                    marginVertical:10}}>
            <Text style={[styles.text,{color:'#fff',fontSize:14,paddingVertical:6,
                        paddingHorizontal:20,fontWeight:'600'}]}>CONTACT</Text>
          </TouchableOpacity>
        </View>
      </View>
    )
